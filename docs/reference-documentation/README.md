...
2. **Bulk local snapshot:** create **`_upstream_snapshot/`** and copy markdown from your local upstream checkout or
   exported docs **manually**, or use the **git** / **curl** / **rsync** patterns in the spec. Optional: use a
   maintainer-provided script under **`scripts/`** if one exists (see root **README.md**, **Reference documentation**).
