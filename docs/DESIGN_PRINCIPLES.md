...
support dumps. For **undisclosed** **security vulnerabilities** in **this package’s verification surface**, follow
**[SPEC_SECURITY_DISCLOSURE.md](SPEC_SECURITY_DISCLOSURE.md)** and the repository root **`SECURITY.md`** policy once
published—**do not** paste exploit-ready material or live secrets into **public** issues first.
