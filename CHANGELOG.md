...
- **SQLite reference idempotency store** (phase **2** spec, backlog **`d10cf76f-e11e-4674-9d81-6d06899b4a64` / *Reference SQLite-backed idempotency store for event_id*`): new **`docs/SPEC_SQLITE_IDEMPOTENCY_STORE.md`** (**SQ1**–**SQ7**, **`SqliteLifecycleWebhookDedupStore`** planned in **`docs/SPEC_PUBLIC_API.md`** **§ Planned** until implementation). Cross-links and traceability in **`docs/SPEC_DELIVERY_IDEMPOTENCY.md`**, **`docs/SPEC_REPLAY_PROTECTION.md`**, **`docs/SPEC_MINIMAL_HTTP_HANDLER.md`**, **`docs/SPEC_AUTOMATED_TESTS.md`** **§ Backlog `d10cf76f`**, **`docs/MISSION.md`**, **`docs/DESIGN_PRINCIPLES.md`**, **`README.md`**.
